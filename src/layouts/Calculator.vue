// build the structure of the interface of the calculator
// construire la structure de l'interface de la calculatrice
<template>
  <div class="container">
...
export default {
  ...
  methods: {
    ...
    dott () {
      ...
      // vérifier si le separateur du decimal est ajouté avant de l'ajouter
...
// design de l'interface avec css
// design of the interface using css
<style>
html,
body {
